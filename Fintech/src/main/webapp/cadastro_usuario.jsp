...
<html lang="pt-br">
	<head>
		...
		<title>Fintech - Novo Usuário</title>
		...
		<div class="container d-flex justify-content-center">
			...
			<form class="my-2 col-md-6" action="login" method="post">
				...
				<div class="form-group mb-3">
					...
					<input type="text" name="nome" class="form-control form-outline" id="id_nome" placeholder="Nome..." maxlength="100" required>
				</div>
				<div class="form-group mb-3">
				...
				<div class="form-group mb-3">
					...
					<input type="password" name="senha1" class="form-control" id="id_senha1" placeholder="Senha..." maxlength="7" onkeyup='check();' required>
				</div>
				<div class="form-group mb-3">
					<label for="id_senha2" class="form-label">Confirme sua senha</label>
					<input type="password" name="senha2" class="form-control" id="id_senha2" placeholder="Senha..." maxlength="7" onkeyup='check();' required>
				</div>
				<button type="submit" class="btn btn-primary d-inline" id="botao_cadastro">Cadastrar</button>
				<a href="login.jsp">
